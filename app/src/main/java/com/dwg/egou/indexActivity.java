...
public class indexActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onResume() {
        ...
        if(lists!=null){
            MyFragment myFragment = (MyFragment) lists.get(2);
            if(MyApp.user!=null&&NetworkDetector.netWorkIsValid(indexActivity.this))
                myFragment.setNickname(MyApp.user.getNickname());
        }
